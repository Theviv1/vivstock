...
function Market() {
  ...
  // };
  // const handleAssetClicks = (currency) => {
  //   setSelectedCurrency(currency);
  //   navigate("/market/local-stocks");
  // };

  const handleAssetClick = (currency) => {
    if (currency === "localStockList") {
      navigate("/market/local-stocks");
    } else {
        ...
        >
          ...
          <div>
            <h3 className="text-lg font-semibold text-white">
              Refer A Friend To Vivstock
            </h3>
            <p className="text-gray-600">
              Get 5% Interest On Thier First Deposit
            </p>
          </div>
        </div>
      </div>
        ...
        {(selectedCurrency === "all" || selectedCurrency === "usd") && (
          ...
          >
            <div className="w-24 h-12 mb-4">
              <div className="w-full h-fullrounded-lg relative top-[-20px]">
