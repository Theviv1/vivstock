...
function ReferralModal({ isOpen, onClose }) {
  ...
  const referralLink = `https://vivstock.com/${username}`;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div 
          className="h-[40px] rounded-full bg-[#000] flex items-center gap-[10px] justify-center group cursor-pointer hover:bg-gray-900 transition-colors max-sm:w-full"
